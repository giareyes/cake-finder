...
NVMCClient.drawTree = function(gl) {
	...
	stack.push();
		...
		this.drawObject(gl, this.cone, this.phongSingleColorMultiLightShader,[1.0, 0.54, 0.12, 1.0],[0,0,0,1]);
	stack.pop();
...
NVMCClient.drawScene = function (gl, num, e_pos) {
 ...
 this.drawSceneWithShader(gl,this.phongSingleColorMultiLightShader, num, e_pos);
};
...
NVMCClient.onInitialize = function () {
	...
	this.phongMultiLightShader = new phongMultiLightShader(gl,1,1);
	this.phongSingleColorMultiLightShader = new phongSingleColorMultiLightShader(gl,1,1);
	/*************************************************************/
